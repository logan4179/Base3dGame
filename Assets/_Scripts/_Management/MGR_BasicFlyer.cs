...
public class MGR_BasicFlyer : PV_Object
{
    ...
    private void Awake()
    {
        ...
        {
            Instance = this;
            LogHistoric("static instance was null. Set it to this.");
        }
        else
        {
    ...
    {
        LogHistoric($"ActivateBasicFlyer('{flyr_passed.name}')");
    ...
    {
        LogHistoric($"UnregisterAndDeactivateBasicFlyer('{flyr_passed.name}')");
    ...
    public void HandlePlayerDeath()
    {
        ...
        foreach(Enemy_BasicFlyer flyr in BasicFlyerInstances_active )
        {
            ...
            {
                flyr.LogHistoric($"Player dead. Reinitializing bug: '{flyr.name}'...", PV_Enums.PV_LogFormatting.Standard, true);
