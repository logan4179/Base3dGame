...
[CreateAssetMenu(menuName = "VertigoObjects/Stats_base_NPC", fileName = "stats_base_npc_")]
public class Stats_base_NPC : ScriptableObject
{
	[Header("[----------MOVEMENT----------]")]
	public float Speed_Move_fast = 6.3f;
	[Tooltip("Movement speed while patrolling.")]
	public float Speed_move_patrol = 0.62f;
	...
	public float Speed_Rotate_fast = 3f;
	...
	[Header("[----------TRAVELLING----------]")]
	[Range(0f, 1.5f)] public float dist_RoughlyThere = 0.3f;
